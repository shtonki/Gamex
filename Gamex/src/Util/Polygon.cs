...
namespace Gamex.src.Util.Polygon
{
    ...
    public class Polygon
    {
        ...
        public Polygon(IEnumerable<Vector> victors)
        {
            Points.AddRange(victors);
            BuildEdges();
        }
    ...
    public class intersect
    {
        ...
        private static void ProjectPolygon(Vector axis, Polygon polygon, ref float min, ref float max)
        {
